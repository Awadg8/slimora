...
const Banner = () => {
    ...
    const renderStars = (rating: number) => {
        ...
        for (let i = 0; i < full; i++) {
            stars.push(
                <svg key={`full-${i}`} className="w-4 h-4 text-[#8EA94D]" fill="currentColor" viewBox="0 0 20 20">
        ...
        if (hasHalf) {
            stars.push(
                <svg key="half" className="w-4 h-4 text-[#8EA94D]" fill="currentColor" viewBox="0 0 20 20">
                    <defs>
                ...
                <div className="absolute top-[70%] md:top-[80%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-10 flex items-center justify-center w-full px-4">
                    <div className="w-full max-w-[580px] backdrop-blur-md bg-[#0a1d20]/70 border border-white/10 rounded-2xl p-6 md:p-10 shadow-2xl">
                        ...
                        <p className="text-center text-[#B5B5B5] text-[13px] md:text-[14px] tracking-wide mb-3">
                            ...
                            across{" "}
                            <span className="text-white font-semibold">67</span> countries
                        </p>
                ...
                <div className="max-width py-10 md:py-16">
                        ...
                        <div>
                            ...
                            {searchQuery && (
                                <p className="text-[#B5B5B5] text-[13px] md:text-[15px] mt-1">
                                    Showing results for &quot;<span className="text-[#8EA94D]">{searchQuery}</span>&quot;
                                </p>
                            )}
                        </div>
                        {filteredClinics.length > 0 && (
                    ...
                    {filteredClinics.length > 0 ? (
                                    ...
                                    <div className="p-5 md:p-6">
                                        ...
                                        <div className="flex items-start justify-between mb-3">
                                            <div className="flex-1 mr-4">
                                                ...
                                                <p className="text-[#B5B5B5] text-[12px] md:text-[13px] mt-1 flex items-center gap-1.5">
                                                    <svg className="w-3.5 h-3.5 text-[#8EA94D] flex-shrink-0" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                                        ...
                                        <div className="flex items-center gap-4 mb-4">
                                            ...
                                            <p className="text-[#B5B5B5] text-[12px] md:text-[13px] flex items-center gap-1.5">
                                                <svg className="w-3.5 h-3.5 text-[#8EA94D]" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                        ...
                        <div className="text-center py-16">
                            <svg className="w-16 h-16 mx-auto text-[#5a7a7f] mb-4" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
