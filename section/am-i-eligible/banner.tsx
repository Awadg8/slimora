  ...
  return (
    <div className="relative w-full flex flex-col min-[1025px]:flex-row justify-center items-center gap-6">
      ...
      <div className="absolute bottom-10 min-[1025px]:relative flex flex-col items-center min-[1025px]:items-start min-[1025px]:mt-0 w-full min-[1025px]:w-[40%]">
        <Interaction>
          <p className="text-[#b5b5b5] font-urbanist text-[18px] sm:leading-[30px] sm:text-[26px]">
            Start Your Journey
          </p>
        </Interaction>
        <Interaction2>
          <p className="text-[#8EA94D] font-urbanist text-[32px] sm:leading-[68px] sm:text-[64px] font-semibold">
            BMI Calculator
          </p>
        </Interaction2>
        <Interaction3>
