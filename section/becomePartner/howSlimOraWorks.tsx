      ...
      <div className="max-width">
        <div className="pt-[70px] pb-[140px]">
          <div className="pb-[119px] md:pb-[144px]">
            <Interaction>
              <h2 className="text-[#FFFFFF] text-[24px] lg:text-[50px] lg:leading-[54px] font-bold text-center">
                How does the SlimOra Balloon work?
              </h2>
            </Interaction>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-[76px] md:gap-[100px]">
            {steps.map((item, index) => (
              <div key={index} className="flex flex-col items-center">
                ...
                <Interaction2>
                  <h2 className="text-[#FFFFFF] text-[24px] md:text-[22px] font-bold pb-[11px] pt-[28px] md:pt-[30px] md:pb-[14px] lg:py-[22px]">
                    {item.title}
                  </h2>
                  <p className="text-[12px] md:text-[16px] leading-[18px] md:leading-[24px] text-justify">
                    {item.desc}
                  </p>
                </Interaction2>
              </div>
