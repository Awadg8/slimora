...
export default function HowItHelps() {
  ...
  bg-[linear-gradient(270deg,#0A1D20_0%,rgba(10,29,32,0)_100%)]"></div>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 pt-[69px] gap-[21px]'>
                    {helpCards.map((card, index) => (
                        <div key={index} className="rounded-[20px] opacity-[0.5px] bg-[linear-gradient(0deg,rgba(0,0,0,0.2),rgba(0,0,0,0.2)),linear-gradient(180deg,#143338_0%,#2D4C3D_23.56%,#8EA94D_100%)] py-[30px] md:py-[40px] px-[10px] justify-center flex flex-col">
