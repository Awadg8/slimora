...
const programmeFeatures = [
    {
        ...
        description: "Receive expert care and support from your clinic team throughout your journey.",
        imagePosition: "left" as const
    },
    {
        image: "/images/how_it_works/more_than2.jpg",
        title: "Nutrition coaching",
        description: "Work 1 on 1 with a coach to build healthier habits and make sustainable food and lifestyle choices.",
        imagePosition: "right" as const
    },
    {
        image: "/images/how_it_works/more_than3.jpg",
        title: "Digital tools powered by AI",
        description: "Track your progress and stay connected to your care team with tools like the SlimOra Connected Scale and SlimOra App.",
        imagePosition: "left" as const
    }
];
