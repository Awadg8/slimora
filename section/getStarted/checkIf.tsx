            ...
            <div className="flex flex-col font-urbanist">
              ...
              <Interaction2>
                <p className="font-light text-sm sm:text-base md:text-[17px] lg:text-[20px] mt-4 md:mt-5 text-[#b5b5b5] text-center lg:text-left">
                  ...
                  questions. This helps us understand if the SlimOra Gastric
                  Balloon is a good fit for your health goals. It only takes a
                  minute and could be your first step towards safe, effective
                  ...
                  <div className="flex flex-col items-center min-[1025px]:items-start gap-3 text-white w-full min-[1025px]:w-auto">
                    ...
                    <div className="flex items-center min-[1025px]:items-end gap-4 sm:gap-5">
                      ...
                      <div className="flex flex-col gap-2">
                        <p
                          className={`font-markpro text-sm sm:text-base font-semibold ${getBmiCategory(bmi).color}`}
                        >
                        ...
                        {bmi >= 27 ? (
                          <div
                            ...
                            style={{
                              background:
                                "linear-gradient(135deg, rgba(142,169,77,0.30) 0%, rgba(142,169,77,0.12) 100%)",
