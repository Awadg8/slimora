...
const CuttingEdge = () => {
  return (
    <section className="text-white py-16 md:pt-25 md:pb-40">
      <div className="max-width">
        {/* Header Section */}
        <div className="flex flex-col lg:flex-row justify-between items-start mb-50 gap-8">
          <div className="lg:w-[48%]">
            <h2 className="text-[24px] md:text-[50px] leading-6 md:leading-[50px] text-right font-urbanist font-semibold text-[#8ea94d]">
              Cutting-Edge Digital Tools
              <br className="hidden lg:block" />
              <span className="text-white text-[24px] md:text-[36px]">
                for Weight-Loss Success.
              </span>
            </h2>
          </div>
          <div className="lg:w-[45%] pt-4">
            <p className="text-sm md:text-[20px] text-white text-justify">
      ...
      {/* Top Olive Bar */}
      <div className="bg-[#5C6B35] py-6 px-8 flex justify-center">
      ...
      <div className="flex justify-center bg-black/20">
        <div className="w-full h-[600px] max-w-[600px] aspect-video relative overflow-hidden">
          <video
