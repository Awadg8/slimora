      ...
      <div className="max-width px-6 md:px-0">
        <Interaction>
          <h2 className="text-white text-xl md:text-[35px] font-bold leading-tight mb-12 md:mb-16 max-w-[1000px]">
            Important information to consider before the placement of an SlimOra
            Gastric Balloon
          </h2>
        </Interaction>
        ...
        <Interaction2>
          <p className="text-[#B5B5B5] italic text-center text-lg md:text-[22px] leading-relaxed max-w-[1100px] mx-auto">
            We encourage you to stay close to modern emergency care facilities
            during the time the balloon is in place, in case serious
            complications arise.
          </p>
        </Interaction2>
      </div>
